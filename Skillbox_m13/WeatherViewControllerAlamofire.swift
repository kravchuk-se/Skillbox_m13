...
class WeatherViewControllerAlamofire: UIViewController {
    ...
    // MARK - Helpers
    let networkHelper = NetworkHelperAlamofire()
...
extension WeatherViewControllerAlamofire: UICollectionViewDataSource {
...
extension WeatherViewControllerAlamofire: UITableViewDataSource {
